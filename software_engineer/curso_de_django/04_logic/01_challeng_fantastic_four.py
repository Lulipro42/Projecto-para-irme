...
"""
text = "RRRRRJJJJjjjjrrrr"

def check_is_balance(text):
    text = text.upper()

    # contar facilmente el numero que aparece una letra
    count_r = text.count("R") # read richards
    count_j = text.count("J") # Jonnhy storm
...
print(check_is_balance("RRJJ"))
print(check_is_balance("RRRRJJJJ"))
print(check_is_balance("RRJJJJJJJJJ"))
print(check_is_balance("awwwwwwwaQAQAQ"))